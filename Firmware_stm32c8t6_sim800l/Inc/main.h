...
/* Private defines -----------------------------------------------------------*/
#define SIM_RST_Pin 		GPIO_PIN_10
...
#define InPwr_Pin 		GPIO_PIN_3
#define InPwr_GPIO_Port 	GPIOA

#define OnSw_Pin 		GPIO_PIN_9
#define OnSw_GPIO_Port 		GPIOA
...
#define knock_GPIO_Port 	GPIOB

#define PID_Pin 		GPIO_PIN_2
